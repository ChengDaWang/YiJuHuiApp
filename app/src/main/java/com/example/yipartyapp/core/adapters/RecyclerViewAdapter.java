...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public RecyclerViewAdapter(Context context, List<MerchantBean> mList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.home_item_movie_list_title.setText(data.getMerchantName());
        holder.home_item_movie_list_Starring.setText(data.getMoney());
        holder.home_item_movie_list_regions.setText(data.getAdresss());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
       ...
       // private TextView home_item_movie_list_director;
        ...
        public ViewHolder(View itemView) {
            ...
            //home_item_movie_list_director = (TextView) itemView.findViewById(R.id.textView33);
            home_item_movie_list_Starring = (TextView) itemView.findViewById(R.id.textView34);//价格
